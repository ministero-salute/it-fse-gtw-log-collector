...
import static it.finanze.sanita.fse2.ms.gtw.logcollector.enums.ConfigItemTypeEnum.GENERIC;
...
class ConfigClientTest {
    ...
    private static final ConfigItemTypeEnum specific = ConfigItemTypeEnum.LOG_COLLECTOR;
